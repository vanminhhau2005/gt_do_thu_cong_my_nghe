				...
				<div className="grid gap-10 lg:grid-cols-2 lg:items-start">
					<div>
						...
						<div className="mt-4 space-y-2 text-sm text-lime-50">
							<p>
								Điện thoại: {" "}
								<a className="text-white hover:text-lime-100 transition" href="tel:0983198045">
									0983198045
								</a>
							</p>
							<p>
								Hotline: {" "}
								<a className="text-white hover:text-lime-100 transition" href="tel:0977390922">
									0977390922
								</a>
							</p>
							<p>
						...
						<div className="mt-8">
							...
							<div className="mt-3 flex flex-wrap gap-x-6 gap-y-2 text-sm">
								...
								<Link className="text-white hover:text-lime-100 transition" to="/gt">Giới thiệu</Link>
					...
					<div className="lg:justify-self-end">
						<p className="text-sm uppercase tracking-[0.3em] text-lime-100">Hotline, Zalo</p>
						<p className="mt-2 text-3xl font-extrabold text-white">0977390922</p>
						<p className="mt-1 text-sm uppercase tracking-[0.3em] text-lime-100">Hotline, Zalo</p>
